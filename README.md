...
Log Analytics Workspace: Centralizes log storage and ingestion for security event data.

Custom Logs: Captures geolocation data of attack origins within the VM.

SEIM Visualization: Integrates with Log Analytics to display attack origins on a world map.

Microsoft Sentinel: Enhances analytics with cloud-native SIEM capabilities, including threat intelligence and advanced visualization.
